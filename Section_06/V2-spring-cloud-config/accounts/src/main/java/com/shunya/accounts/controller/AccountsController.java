package com.shunya.accounts.controller;

import com.shunya.accounts.constants.AccountsConstants;
import com.shunya.accounts.dto.AccountsContactInfoDto;
import com.shunya.accounts.dto.CustomerDto;
import com.shunya.accounts.dto.ErrorResponseDto;
import com.shunya.accounts.dto.ResponseDto;
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create a new Customer and Account inside ApexBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to Fetch Customer and its Account details based on mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
